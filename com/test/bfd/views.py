...
from account.modify_password import *
from account.service_count_used import *
from account.show_userinfo import *
...
#             # get_userinfo(request,username)
#             if request.POST.has_key( 'save_tel' ):
#                 user_tel = request.POST.get( 'hidden_tel', None )
#                 print "new tel:", user_tel
#                 if user_tel is not None:
#                     update_tel( username, user_tel )
#             user_dict = show_userinfo( username )
#             email = user_dict["email"]
#             tel = user_dict["tel"]
#             token = user_dict["token"]
